...
def coins(amount): 
    ...
    print("coins of 10:", coins_10)
    amount %= 10 #$Saca el sobrante del paso anterior
    coins_5 = amount // 5
    print("coins of 5:", coins_5) ##calcula la cantidad de monedas de 5.
    amount %= 5 #Saca el sobrante al paso anterior.
    coins_1 = amount
    print("coins of 1:", coins_1) #Todo lo sobrante lo convierte en monedas de 1.
    print("Total coins =", coins_1 + coins_5 + coins_10)
    count = []
